...
public class CreateDatabase {
     ...
     */
    public static void writeDatabase(File crawlerDirectory, File databaseFile, @Nullable File versionFile) {
        ...
        try {
            ...
            if (versionFile != null) {
                try {
                    ...
                    System.out.println("Failed to write database hash file.");
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
